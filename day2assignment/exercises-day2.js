...
//4. Create a function named `sumOfArray` that loops through an array, 
//and returns the sum of all the numbers that are less than or equal to 5
...
//5. Create a variable `rect` that represents a rectangle. This should be
...
//6. console.log the x- and y- coordinates of the rectangle (its location). 
//Your output should have the format `"X, Y"`.
console.log("X coordinates are " + rect.x, " Y coordinates are " + rect.y)
...
var shapes = ['square', 'circle', 'rectangle', 'triangle', 'oval'];
console.log(shapes)
...
//12. Calculate the hypotenuse of the triangle and assign the value to a  
//'hypotenuse'property inside the triangle object
...
// hypotenuse = the square root of (a^2 + b^2)(base^2 + height^2)
